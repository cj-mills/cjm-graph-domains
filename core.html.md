...
```
    ...
    Person: id='a8a100d3-4f7b-4ad6-a476-e0a0d07957a6' name='Alice' role='speaker'
    Label: Person
...
```
    ...
    GraphNode ID: a8a100d3-4f7b-4ad6-a476-e0a0d07957a6
...
```
    ...
    Sources: 1
    Source ref: SourceRef(plugin_name='cjm-transcription-plugin-voxtral-hf', table_name='transcriptions', row_id='job-123', content_hash='sha256:90fc4487461482ec8f7022c3e058f6c026959a444b7deb6cd28dd77190a99de0', segment_slice='timestamp:00:10-00:30')
